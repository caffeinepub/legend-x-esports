...
export class Backend implements backendInterface {
    ...
    async addOrUpdateRosterMember(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addOrUpdateRosterMember(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllRosterMembers(): Promise<Array<RosterMember>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllRosterMembers();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeRosterMember(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeRosterMember(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
